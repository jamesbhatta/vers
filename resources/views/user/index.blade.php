        ...
        <div class="box">
            <div class="box__header">
                <div class="d-flex">
                    ...
                    <div class="ml-auto">
                        <a class="btn btn-primary z-depth-0" href="{{ route('user.create') }}"><span class="mr-2"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach ($user->getRoleNames() as $role)
                                        <span class="py-1 px-2 d-inline-block shadow-none text-left rounded text-capitalize"
                                ...
                                <td class="text-nowrap text-right">
                                    <a href="{{ route('password.change.form', $user) }}" class="action-btn text-primary"><i
