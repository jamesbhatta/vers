                ...
                <div class="box mt-2 p-3">
                    ...
                    <form action="{{ $marriage->id ? route('marriage.update', $marriage) : route('marriage.store') }}"
                        ...
                        @isset($marriage->id)
                            @method('PUT')
                        @endisset
                        <h4 class="font-weight-bold pb-3">विवाह दर्ता विवरण </h4>
                                ...
                                <div class="card mt-3 p-3 pb-2">
                                    <div class="row">
                                        <div class="form-group col-xl-3">
                                            <label>* साची को नाम </label>
                                            <input type="text" name="relative_name" class="form-control"
                                                value="{{ old('relative_name', $marriage->relative_name) }}">
                                            @error('relative_name')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group col-xl-3">
                                            <label for="">* साचीसंगको सम्बन्ध</label>
                                            <div class="input-group mb-2">
                                                <input type="text" name="relationship" class="form-control"
                                                    value="{{ old('relationship', $marriage->relationship) }}" />
                                            </div>
                                            @error('relationship')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        ...
                                        <div class="form-group col-xl-3">
                                            <label for="">* साचीको ठेगाना</label>
                                            <div class="input-group mb-2">
                                                <input type="text" name="relative_address" class="form-control"
                                                    value="{{ old('relative_address', $marriage->relative_address) }}" />
                                            </div>
                                        ...
                                        <div class="form-group col-xl-3">
                                            <label for="">* साची मिति</label>
                                            <div class="input-group mb-2">
                                                <input type="text" name="date" id="nepali-datepicker5"
                                                    value="{{ old('date', $marriage->date) }}" class="form-control" />
                                            </div>
                                            @error('date')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
