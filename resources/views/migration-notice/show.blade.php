            ...
            <div class="container-fluid">
                ...
                <div class="card p-5 mt-5">
                        ...
                        <div class="p-5 mt-2">
                            <div style="text-align: justify" class="">
                                <div class="row" style="text-align: justify">
                                    (२) कहाँ सरी जाने <p style="border-bottom: dashed; width: 15%" class="text-center">
                                    ...
                                    <p style="border-bottom: dashed; width:45%" class="text-center">&nbsp;
                                        ...
                                        style="border-bottom: dashed; width: 10%" class="text-center">
                                        {{ $migrationCertificate->after_ward }}</p> टोलको नाम &nbsp;
                                    <p style="border-bottom: dashed; width: 15%" class="text-center">&nbsp;
                                        {{ $migrationCertificate->after_village }}</p> घर
                                    नं &nbsp;<p style="border-bottom: dashed; width: 7%" class="text-center">
                                ...
                                <div class="row" style="text-align: justify">
                                    ...
                                    नं. &nbsp;<p style="border-bottom: dashed; width:10%" class="text-center">
                                        &nbsp;{{ $migrationCertificate->before_ward }}&nbsp;</p>
                                    टोलको नाम &nbsp;<p style="border-bottom: dashed; width: 20%" class="text-center">
                                    ...
                                    <p style="border-bottom: dashed; width: 20%" class="text-center">
                    ...
                    <div class="col-lg-12 mt-2">
                        <h3 class="text-center h5 font-weight-bold ">सम्बन्धित फाइल</h3>
